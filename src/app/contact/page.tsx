...
import { Phone, Mail, MapPin, ArrowLeft, Clock, Users, Globe, MessageCircle, ChevronDown } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              {t('contactTitle').split(' ').slice(0, 2).join(' ')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-green-400 to-lime-400">{t('contactTitle').split(' ').slice(2).join(' ')}</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="bg-gray-800/50 backdrop-blur-sm border border-emerald-500/30 rounded-2xl p-8">
                <h2 className="text-2xl font-bold text-white mb-6">{t('contactInformation')}</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-400 font-medium">+1 (850) 565-1031</p>
                      <p className="text-gray-400 text-sm">{t('phoneAvailable')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-400 font-medium">contact@apexvistaai.com</p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">{t('locationClick')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-1">{t('socialMedia')}</h3>
                      <a 
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">Follow us on Facebook</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-emerald-500/30 rounded-2xl p-8">
              ...
              <div className="mt-6 p-4 bg-gray-900/50 rounded-lg border border-gray-700/50">
                <p className="text-sm text-gray-400 text-center">
                  <strong className="text-white">{t('responseTime')}</strong> {t('responseTimeContact')}
                </p>
              </div>
            </div>
          </div>
